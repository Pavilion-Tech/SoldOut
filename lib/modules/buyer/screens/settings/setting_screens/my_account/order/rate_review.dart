                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(tr('tap_on_stars'),style: TextStyle(color: HexColor('#A0AEC0'),fontSize: 12),),
                          SizedBox(height: 10,),
                          RatingBar.builder(
                            initialRating: rate,
                            itemSize: 40,
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(color: HexColor('#A0AEC0'),fontSize: 13,height: 5),
                        ),
                        maxLines: 5,
                      ),
                    ),
                    ...
                    Align(
                        alignment: AlignmentDirectional.center,
                        child: defaultButton(onTap: (){}, text: tr('submit_review')))
                  ],
                ),
            ),
          ],
